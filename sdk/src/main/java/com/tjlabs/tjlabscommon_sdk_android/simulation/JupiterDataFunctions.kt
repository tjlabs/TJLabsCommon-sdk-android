...
internal object JupiterDataFunctions {
    ...
    fun saveEventResultAsJson(
        ...
        val eventFileName = "android_${normalizeFileToken(userId, "unknown_user")}_${normalizeFileToken(saveServiceStartTime, "0")}_event.json"
        val jsonLine = "{\"mobile_time\":$mobileTime," +
    ...
    fun loadRfdJsonData(app: Application, userId: String, serviceStartTime: String): List<RfdJsonRecord> {
        val fileName = "android_${normalizeFileToken(userId, "unknown_user")}_${normalizeFileToken(serviceStartTime, "0")}_rfd.json"
    ...
    fun loadUvdJsonData(app: Application, userId: String, serviceStartTime: String): List<UvdJsonRecord> {
        val fileName = "android_${normalizeFileToken(userId, "unknown_user")}_${normalizeFileToken(serviceStartTime, "0")}_uvd.json"
